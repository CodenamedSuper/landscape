...
public class SongbirdModel<T extends Songbird> extends HierarchicalModel<T> {
    ...
    public SongbirdModel(ModelPart root) {
        ...
        this.left_wing = this.songbird.getChild("left_wing");
        this.right_wing = this.songbird.getChild("right_wing");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition songbird = partdefinition.addOrReplaceChild("songbird", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 27.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

        PartDefinition main = songbird.addOrReplaceChild("main", CubeListBuilder.create().texOffs(1, 17).addBox(-2.0F, -6.0F, -5.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition left_wing = songbird.addOrReplaceChild("left_wing", CubeListBuilder.create(), PartPose.offset(-2.7149F, -7.7185F, 1.5F));

        PartDefinition cube_r3 = left_wing.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(24, 11).addBox(-6.8F, -2.6F, 0.0F, 1.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.7149F, 4.7185F, -2.5F, 0.0F, 0.0F, 0.3491F));

        PartDefinition right_wing = songbird.addOrReplaceChild("right_wing", CubeListBuilder.create(), PartPose.offset(2.6652F, -7.7344F, 1.5F));

        PartDefinition cube_r4 = right_wing.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(24, 1).addBox(2.0F, -4.0F, 0.0F, 1.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.6652F, 4.7344F, -2.5F, 0.0F, 0.0F, -0.3491F));

        PartDefinition legs = songbird.addOrReplaceChild("legs", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition right_leg = legs.addOrReplaceChild("right_leg", CubeListBuilder.create(), PartPose.offset(0.5F, -4.05F, 1.0F));
        ...
        PartDefinition cube_r6 = right_leg.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(18, 16).addBox(-1.0F, 1.0F, 3.0F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 4.05F, -1.0F, 1.5708F, 0.0F, 0.0F));

        PartDefinition left_leg = legs.addOrReplaceChild("left_leg", CubeListBuilder.create(), PartPose.offset(0.0F, -4.0F, 1.0F));
        ...
        PartDefinition cube_r8 = left_leg.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(18, 16).addBox(-1.0F, 1.0F, 3.0F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 4.0F, -1.0F, 1.5708F, 0.0F, 0.0F));
